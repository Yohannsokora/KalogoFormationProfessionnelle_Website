...
// Generate a Word document and return a Blob suitable for browser download
export async function generateDocument(
      ...
      sections: [
        {
          properties: {},
          children: [
            new Paragraph({ text: "FICHE D'INSCRIPTION – KALOGO FORMATION PROFESSIONNELLE (KFP)", heading: "Heading1" }),
  ...
  // In browser, return a Blob for direct download
